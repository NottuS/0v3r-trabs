...
NS_LOG_COMPONENT_DEFINE ("ospfv1ScriptExample");
...
main (int argc, char *argv[])
{
	...
	if (verbose) {
		LogComponentEnable ("ospfv1ScriptExample", LOG_LEVEL_INFO);
	...
	csma.EnableAsciiAll (ascii.CreateFileStream ("ospfv1.tr"));
	csma.EnablePcapAll ("ospfv1", true);
