...
NS_LOG_COMPONENT_DEFINE ("RoutersScriptExample");
...
main (int argc, char *argv[])
{
	...
	if (verbose) {
		LogComponentEnable ("RoutersScriptExample", LOG_LEVEL_INFO);
	...
	csma.EnableAsciiAll (ascii.CreateFileStream ("routers.tr"));
	csma.EnablePcapAll ("routers", true);
	pointToPoint.EnablePcapAll ("routers", true);
