...
/*    ===   INICIA MODIFICAÇÃO   ===   */
   /**
   * \param router identifies whether this node is a router.
   */
  Node(bool router);
  
   /**
   * \returns whether this node is a router.
   */
  bool GetRouter (void) const;
...
/*    ===   INICIA MODIFICAÇÃO   ===   */
  bool        m_router;     // Identifies whether this node is a router
/*    ===   FINALIZA MODIFICAÇÃO   ===   */
